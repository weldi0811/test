var menu,
    ...
    do {
        do {
            ...
            if(!Number.isInteger(menu)){ // menu bukan sebuah integer
                check2 = true
                alert("Mohon input sebuah angka")
            } else if (menu < 0 || menu > 2){
                check2 = true
                alert("Mohon masukkan angka antara 1 - 3")
            }
        } while (check2);
        
        jumlah[menu] = jumlah[menu] + parseInt(prompt("Masukan jumlah " + produk[menu]))
